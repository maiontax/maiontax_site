export default function PrivacyPolice() {
    return (
        <section className="page-policy-privace container-view">
            <h2>Política Privacidade</h2>
            <p>A sua privacidade é importante para nós. É política do Maion Tax respeitar a sua privacidade em relação a qualquer
                informação sua que possamos coletar no site <a href="maiontax.com.br">Maion Tax</a>, e outros sites que possuímos e
                operamos.</p>
            ...
            <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle
                sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <a
                    href="https://privacidade.me/" target="_BLANK" style={{ color: "#616060", textDecoration: "none" }}>políticas de
                    privacidade</a>. </p>
            ...
            <h2>Segurança do site Maion Tax</h2>
            <p>O site é confiável e seguro para o usuário conforme informado pelo <a target="_BLANK" style={{
                color: "#616060",
                textDecoration: "none"
            }} href="https://sitecheck.com.br" rel="noopener noreferrer">Site
                Check</a>. A página verifica informações do site para identificar possíveis problemas de segurança. </p>
            <h2>Política de Cookies Maion Tax</h2>
            ...
            <ul>
                <li> Este site usa o <a href="https://analytics.google.com/analytics/web/">Google Analytics</a>, que é uma das
                    soluções de análise mais difundidas e confiáveis ​​da Web, para nos ajudar a entender como você usa o site e
                    como podemos melhorar sua experiência. Esses cookies podem rastrear itens como quanto tempo você gasta no site e
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Maion Tax oferece no site e com
            ...
            <ul>
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Maion Tax, de seus fornecedores ou
            ...
            <p> O usuário pode bloquear e/ou desativar os cookies de qualquer site, inclusive o nosso a qualquer momento. Para
            ...
            <ul>
                ...
                <li> <a target="_blank" rel="noopener noreferrer"
                    ...
                    Microsoft Edge </a> </li>
                <li> <a target="_blank" rel="noopener noreferrer"
                    href="https://blogs.opera.com/news/2015/08/how-to-manage-cookies-in-opera/"> Opera </a> </li>
                <li> <a target="_blank" rel="noopener noreferrer" href="https://support.apple.com/pt-br/guide/safari/sfri11471/mac">
                    Safari </a>. </li>
            </ul>
            ...
            <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa
                ...
                site.</p>
            <p>Esta política é efetiva a partir de <strong>Aug</strong>/<strong>2024</strong>.</p>
        </section>
    )
}